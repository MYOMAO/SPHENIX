...
TString ordertag = "Simulations-0Degree";
...
TString InputFile="/sphenix/user/zshi/SimulationWork/2019sPHENIXAna/EMCAL/Simulations/macros/macros/prototype4/condor/directory/outputfiles/FileList.lst_EMCalCalib_0Deg.root";
...
double Y2 = 51 + xshift;
double Y3 = 78 + xshift;
double Y4 = 105 + xshift;
double Y5 = 132 + xshift;
double Y6 = 159 + xshift;
double Y7 = 186 + xshift;
