...
TString InputFile="/sphenix/user/zshi/SimulationWork/2019sPHENIXAna/EMCAL/Simulations/macros/macros/prototype4/condor/directory/outputfiles/FileList.lst_EMCalCalib_5Deg.root";
...
const int Xmax = 250 - correction;
const int Ymin = 0 - correction;
const int Ymax = 220 - correction;
const int Emin = 0;
const int Emax = 13;
const int Statmin = 0;
...
double x1 = 70 + yshift;
double x2 = 95 + yshift;
double x3 = 120 + yshift;
double x4 = 145 + yshift;
double x5 = 170 + yshift;
double x6 = 195 + yshift;
double x7 = 220 + yshift;


double Y1 = 32 + xshift;
double Y2 = 57 + xshift;
double Y3 = 82 + xshift;
double Y4 = 107 + xshift;
double Y5 = 132 + xshift;
double Y6 = 157 + xshift;
double Y7 = 182 + xshift;
double Y8 = 207 + xshift;
