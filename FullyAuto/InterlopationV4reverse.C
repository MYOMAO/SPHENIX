...
*/
		...
		if(year == 2017)
		{
		int blockxmin =  Inter->GetXaxis()->FindBin(x2);
		int blockxmax =  Inter->GetXaxis()->FindBin(x4);
		int blockymin =  Inter->GetYaxis()->FindBin(y2);
		int blockymax =  Inter->GetYaxis()->FindBin(y4);
	}
